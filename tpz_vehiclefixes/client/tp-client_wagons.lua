    ...
    Citizen.CreateThread(function()
        ...
        while true do
            ...
            for i = 1, #vehiclePool do -- loop through each vehicle (entity)
                ...
                -- Is wagon stopped
                if wagon and IsEntityAVehicle(wagon) and IsVehicleStopped(wagon) and not IsEntityAMissionEntity(wagon) then
